        ...
        @if ($order && $order->product)
            <div class="card shadow-sm p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="mt-3">
                            ...
                            <p><strong>Harga Satuan:</strong> Rp {{ number_format($order->product->price, 0, ',', '.') }}
                            </p>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-6 fw-bold text-success">: Rp {{ number_format($order->total_price, 0, ',', '.') }}
                    </div>
                </div>
                ...
                <div class="border rounded p-3 mb-3">
                    ...
                    <p><strong>Alamat:</strong> {{ auth()->user()->alamat }}, {{ auth()->user()->kota }},
                        {{ auth()->user()->provinsi }} ({{ auth()->user()->kode_pos }})</p>
